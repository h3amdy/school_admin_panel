...
import 'package:ashil_school/features/curriculum/views/curriculum_details_view.dart';
// [MODIFIED] تم تعديل المسار ليتطابق مع ملفات المشروع
// [DELETED] لم نعد بحاجة لـ GradeController هنا
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // [DELETED] تم حذف كل منطق GradeController من هنا

    // [MODIFIED] بناء قائمة الصفحات أصبح مباشراً
    final List<Widget> pages = [];

    pages.addAll([
      TeachersPage(),
      // [MODIFIED]
      // نحن فقط نمرر قيم فارغة.
      // CurriculumDetailsView سيتجاهلها ويقوم بتحميل
      // الصف الصحيح (المحفوظ) من GetStorage بنفسه.
    ...
    // [DELETED] تم إزالة Obx الذي كان يغلف الـ Scaffold
    return Scaffold(
      body: PageView(
      ...
      // [MODIFIED] قمنا بتغليف الـ Container بـ Obx
      // هذا ضروري فقط لتحديث "الاختيار" (isSelected) في الأيقونات
